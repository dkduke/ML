...
def download_mp4(mp4_url,path):
    path="/Users/dengkun/Downloads/squsreDance2/{}.mp4".format(path)
    print(path)
...
if __name__=='__main__' :
    start_urls=['http://www.9igcw.com/e/search/result/index.php?page={}&searchid=3158'.format(i) for i in range(1,3)]
    main()
